    ...
    <body>
        ...
        <div class= "container bgColor">
            <main role= "main" class="pb-3">
                ...
                <section style =  "position:relative; left:370px; top:200px; background-color: #F3F3F3; width:450px;  height:350px; border-radius:10px;    0em 0em; box-shadow:0 18px 16px 0 rgba(1,1,1,0.2), 0 10px 20px 0 rgba(1,1,1,4);">
                    ...
                    <form method=  "post"><br>
                        ...
                        if( isset($_POST['submit'])){
                            ...
                            if($data[0][0]==$_POST['UID'] && $data[0][1] == $_POST['pwd']){
                                ...
                                header("Location:Admin.php"); } else{echo "Incorrect Login "; }
                            }
                            ?>
                        </form>
                    </section>
